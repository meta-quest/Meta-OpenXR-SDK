...
class XrHandHelper : public XrHelper {
   ...
   public:
    ...
    void SetHandDataTypeNatural(bool handDataTypeNatural) {
        handDataTypeNatural_ = handDataTypeNatural;
    }

   private:
    bool isLeft_;
    bool onController_ = false;
    ...
    bool handDataTypeNatural_ = true;
};
